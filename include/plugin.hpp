...
namespace httpevent {
    ...
    public:
        ...
        plugin(const std::string dir, Poco::ClassLoader<httpevent::view>* class_loader)
        : dir(dir)
    ...
    private:
        ...
        void unload() {
            ...
            Poco::ClassLoader<httpevent::view>::Iterator it = this->class_loader->begin();
    ...
    private:
        std::string dir;
        Poco::ClassLoader<httpevent::view>* class_loader;
